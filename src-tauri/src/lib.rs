...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::db::meetings::save_meeting,
            commands::db::meetings::get_meetings,
            commands::db::meetings::update_meeting_status,
            commands::db::processing_chunks::save_processing_chunks,
            ...
            commands::db::transcriptions::get_transcription_by_meeting,
            commands::db::transcriptions::save_speaker_map,
            commands::db::structured_minutes::save_minutes,
            commands::db::structured_minutes::get_minutes_by_meeting,
            commands::db::structured_minutes::get_structured_minutes_by_meeting,
            commands::db::structured_minutes::get_minute_evidences,
            commands::db::structured_minutes::edit::update_minute_action,
            commands::db::structured_minutes::edit::update_minute_decision,
            commands::db::structured_minutes::edit::save_minute_revision,
            commands::db::structured_minutes::edit::update_minute_participants,
            commands::db::structured_minutes::edit::restore_minute_version,
